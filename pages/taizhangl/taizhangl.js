...
Page({
    data: {
        ...
        indexListx: [],
        addshow: false,
        navurl: '/pages/taizhangsh/taizhangsh?id=',
        date: '',
        navshow: false,
        type: 'day',
        dateType: 'day',
    ...
    onLoad: function (options) {
        ...
        if (roles == 'qy') {
            that.setData({
              addshow: true,
              navurl: '/pages/taizhangxq/taizhangxq?id='
            })
          }
        that.listXuan(1)
    },
    listXuan: function(pageNum) {
        var that = this;
        wx.request({
          url: app.ajaxUrl + 'system/tzdj/list',
          data: {
            item1: that.data.titleInput,
            item2: that.data.date,
          ...
          success (res) {
            ...
            if (resData.code == 200) {
                ...
                for (var i = 0; i < data.length; i ++) {
                  if (data[i].type == 'month') {
                    data[i].tbDate = data[i].tbDate.substring(0,7)
                  }
