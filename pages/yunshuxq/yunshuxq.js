...
Page({
    ...
    onLoad: function (options) {
      ...
      var that = this;
        ...
        wx.request({
          url: app.ajaxUrl + 'system/ysqy/' + options.id,
          data: {},
          method: 'get',
          dataType: 'json',
          header: {
    ...
    submitClick: function() {
      var that = this;
      wx.navigateTo({
        url: '/pages/yunshuxqs/yunshuxqs?id=' + that.data.ysqyid
      });
    },
    submitData: function() {
      var that = this;
      wx.request({
        url: app.ajaxUrl + 'system/ysqy/update',
        data: {
          id: that.data.ysqyid,
    ...
    removeData: function() {
      var that = this;
      wx.request({
        url: app.ajaxUrl + 'system/ysqy/delete/' + that.data.ysqyid,
        data: {},
        method: 'post',
        dataType: 'json',
        header: {
