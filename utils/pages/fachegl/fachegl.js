...
Page({
    data: {
        ...
        indexListx: [],
        addshow: false,
        navurl: '/pages/fachesh/fachesh?id=',
        navshow: false
    },
    //搜索框vale 改变
    ...
    onLoad: function (options) {
        ...
        if (roles == 'qy') {
            that.setData({
              addshow: true,
              navurl: '/pages/fachexq/fachexq?id='
            })
        }
        if (roles == 'gl') {
          that.setData({
    ...
    listXuan: function(pageNum) {
        var that = this;
        wx.request({
          url: app.ajaxUrl + 'system/fcfwgl/list',
          data: {
            gfName: that.data.titleInput,
